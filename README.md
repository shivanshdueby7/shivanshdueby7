...
| **snapquote** | Quote generator web app (Next.js + Supabase + Stripe) | [snapquote](https://github.com/shivanshdueby7/snapquote) |
| **chat-app** | Real-time mobile chat application | [chat-app](https://github.com/shivanshdueby7/chat-app) |
| **vitalis** | Android health & wellness tracker (Kotlin) | [vitalis](https://github.com/shivanshdueby7/vitalis) |
| **shivansh-portfolio** | My personal portfolio website | [shivansh-portfolio](https://github.com/shivanshdueby7/shivansh-portfolio) |
